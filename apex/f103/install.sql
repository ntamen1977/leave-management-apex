...
@@application/shared_components/files/gescon_css.sql
@@application/plugin_settings.sql
@@application/shared_components/security/authorizations/administration_rights.sql
@@application/shared_components/security/authorizations/is_employee.sql
@@application/shared_components/security/authorizations/is_manager.sql
@@application/shared_components/security/authorizations/is_admin.sql
@@application/shared_components/navigation/navigation_bar.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/departments_department_code.sql
@@application/shared_components/user_interface/lovs/employees_employee_number.sql
